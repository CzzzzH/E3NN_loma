...
def train(epoch):
    ...
    for data in dataset.train_loader:
        ...
        loss.backward()
        loss_all += mul_op(loss, data.num_graphs) if args.backend == "loma" else loss * data.num_graphs
        optimizer.step()
        
    return div_op(loss_all, len(dataset.train_loader.dataset)) if args.backend == "loma" else loss_all / len(dataset.train_loader.dataset) 
